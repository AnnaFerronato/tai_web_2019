...
class controleAluno
{
    ...
    public static function loadTabelaAlunos()
    {
        ...
        while ($objAluno = $alunos->fetchObject()) {
            ...
            echo "<td>";
            echo "<a href='viewAlunoAlterar.php?id=$objAluno->id' class='btn btn-info glyphicon glyphicon-pencil' role='button'>Alterar</a>";
            echo "<a href='viewAlunoRemover.php?id=$objAluno->id' class='btn btn-danger glyphicon glyphicon-remove' role='button'>Excluir</a>";
            echo "</td>";
            echo "</tr>";
        }
    }
